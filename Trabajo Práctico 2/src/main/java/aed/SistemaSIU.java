...
// Complejidad Ejercicio 9:
/*
  * Idem al ejercicio anterior solo que ahora sumo el costo de acceder a las materias.
...
// Comentarios finales:
/*
  * Nuestra idea para implementar el TAD SistemaSIU fue utilizar el constructor para crear
    'caminos' en _carreras que llevan a todas las materias y en cada materia guardar los
    datos relevantes.Incluido un 'mapa' para encontrar todos los caminos que llevan a esa 
    materia.Luego en los demas metodos operamos con las materias recorriendo cada camino que
    nos daban.
    
  * En _estudiantes solo guardamos la cantidad de materias que estaban inscriptos por que
    eso era lo unico que nos pedian de cada estudiante pero hubiesemos podido guardar mas 
    informacion de ser necesario.
 */
